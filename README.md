...
<!--
  Every asset below is generated by scripts/generate_profile_assets.py and
  committed into assets/. Nothing here is fetched from a third-party widget
  service at render time, so nothing can 503, rate-limit, or lapse on billing.
  A daily Action refreshes the numbers. See assets/README.md.
-->

<img width="100%" src="assets/header.svg" alt="Shiva Ganesh Talikota — Product Development Engineer" />

<a href="https://shivaganesht.vercel.app">
  <img src="assets/typing.svg" alt="Product Development Engineer @ matriXO — RAG pipelines, agentic workflows, shipped products" />
</a>
...
<img height="195" src="assets/stats.svg" alt="GitHub activity summary" />
<img height="195" src="assets/languages.svg" alt="Language distribution across public repositories" />

<br/><br/>

<img width="97%" src="assets/activity.svg" alt="Contribution heatmap for the last year" />
...
<img width="100%" src="assets/footer.svg" alt="Building from Hyderabad, India — open to 2026 roles" />
